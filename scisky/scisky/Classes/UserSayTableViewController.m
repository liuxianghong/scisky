//
//  UserSayTableViewController.m
//  scisky
//
//  Created by 刘向宏 on 15/7/9.
//  Copyright (c) 2015年 刘向宏. All rights reserved.
//

#import "UserSayTableViewController.h"
#import "UserSayTableViewCell.h"

@interface UserSayTableViewController ()

@end

@implementation UserSayTableViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg",indexPath.row+1]];
    CGFloat width = tableView.width-30;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UserSayTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UserSay" forIndexPath:indexPath];
    cell.imageViewS.image = [UIImage imageNamed:[NSString stringWithFormat:@"%ld.jpg",indexPath.row+1]];
    // Configure the cell...
    return cell;
}
